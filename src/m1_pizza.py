...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  5 slices, thin (thickness=3) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    # Test 3:
    title = 'Polygon Test 3: 8 segments with thick green lines'
    window = rg.RoseWindow(550, 450, title)
    circle = rg.Circle(rg.Point(100, 100), 90)
    circle.outline_thickness = 5
    polygon(window, circle, 8, 'green', 10)
    window.continue_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 20, 5, 'cyan', 5)
    window.close_on_mouse_click()
